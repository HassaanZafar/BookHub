				...
				%>
						...
						<input type="hidden" name="id" value="<%=b.getBookId() %>">
							...
							<div class="form-group">
								<label for="exampleFormControlFile1">Book Name*</label> <input
									name="bname" type="text" class="form-control"
									id="exampleInputEmail1" aria-describedby="emailHelp" value="<%=b.getBookName()%>">
							</div>
							<div class="form-group">
								<label for="exampleFormControlFile1">Author Name*</label> <input
									name="author" type="text" class="form-control"
									id="exampleInputEmail1" aria-describedby="emailHelp" value="<%=b.getAuthor()%>">
							</div>
							<div class="form-group">
								<label for="exampleFormControlFile1">Price*</label> <input
