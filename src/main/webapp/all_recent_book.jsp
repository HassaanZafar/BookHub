					...
					<div class="card-body text-center">
						...
						<%
							...
							<div class="row">
								<% if(u==null)
								{%>
									<a href="login.jsp" class="btn btn-info btn-sm ml-1"><i
						class="fa-solid fa-cart-arrow-down"></i>Add to cart</a>
									<%}
								else{
									%>
									<a href="cart?bid=<%=b.getBookId() %>&&uid=<%=u.getId() %>" class="btn btn-info btn-sm ml-1"><i
						class="fa-solid fa-cart-arrow-down"></i>Add to cart</a>
									<% 
								}
									%>
								...
								<a href="view_books.jsp?bid=<%=b.getBookId() %>" class="btn btn-danger btn-sm ml-2"> View Details </a> <a
									href="" class="btn btn-secondary btn-sm ml-1"> <%=b.getPrice()%><i class="fa-solid fa-dollar-sign"></i></a>
							</div>
						<%}
